...
1. _Ejecuten este código tal cual se presenta_ pero _Cambien el chunk de código para que ejecute el código y no muestre resultados._
...
Completa el código para poder obtener el conjunto de datos `palabras` para luego realizar la nube de palabras. En este caso también _Cambien el chunk de código para que ejecute el código y no muestre resultados._
